...
function exercise1(num1) {
  ...
  //varA and varB wouldn't pass the test if we were comparing booleans, arrays, or objects.
  // EXERCISE 6.
  ...
  function exercise8(amount1, amount2, minimum, maximum) {
    ...
    // Write your code for the exercise below here:
    // --------------------------------------------
      if (amount1 >= minimum && amount1 <= maxiumim && amount2 >= minimum && amount2 <= maximum) {
          answer8 = true;
      } else {
          answer8 = false;
      }
